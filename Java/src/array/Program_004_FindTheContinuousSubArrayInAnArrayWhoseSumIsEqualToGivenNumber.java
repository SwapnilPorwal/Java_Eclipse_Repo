...
public class Program_004_FindTheContinuousSubArrayInAnArrayWhoseSumIsEqualToGivenNumber 
{
	...
	static void findSubArray(int[] inputArray, int inputNumber)
    {
        ...
        { //Adding inputArray[i] to the current 'sum' 
        	...
        	//If sum is greater than inputNumber then following loop is executed until //sum becomes either smaller than or equal to inputNumber 
